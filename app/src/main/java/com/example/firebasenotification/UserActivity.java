...
public class UserActivity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        intent.putExtra(CONTAT_KEY, user.getContact());
    ...
    private void showUpdateDialog(final String id, final String name, final String email, final String contact, String city, String lang) {
        ...
        final EditText edit_name = (EditText) view.findViewById(R.id.update_name);
        final EditText edit_email = (EditText) view.findViewById(R.id.update_email);
        final EditText edit_contact = (EditText) view.findViewById(R.id.update_contact);
        final Spinner spinner_city = (Spinner) view.findViewById(R.id.update_city);
        final AutoCompleteTextView autoCompleteTextView_ = (AutoCompleteTextView) view.findViewById(R.id.update_lang);
